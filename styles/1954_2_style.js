...
var style_1954_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelFont = "15.600000000000001px \'NSimSun\', sans-serif";
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("姓名") !== null) {
        labelText = String(feature.get("姓名"));
    }
